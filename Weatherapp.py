...
def getWeather():
    ...
    # (
        ...
        + "&units=metric&exclude=hourly&appid=2606f769271b8d545fe3458b2b72ed9f"
    )
    print(api)
...
# icon
logo = "D:/2. College Work (Degree)/Second Year/3rd sem/Z. Mini Project – 1 A/weather forecast/Images/logo.png"
image_icon = PhotoImage(file=logo)
root.iconphoto(False, image_icon)
roundedRectangleImage = "D:/2. College Work (Degree)/Second Year/3rd sem/Z. Mini Project – 1 A/weather forecast/Images/Rounded Rectangle 1.png"
round_box = PhotoImage(file=roundedRectangleImage)
Label(root, image=round_box, bg="#57adff").place(x=30, y=110)
# /label
label1 = Label(
    root, text="Temprature", font=("Helvetica", 11), fg="white", bg="#203243"
)
...
## Search Box
roundedRectangleImage3 = "D:/2. College Work (Degree)/Second Year/3rd sem/Z. Mini Project – 1 A/weather forecast/Images/Rounded Rectangle 3.png"
Search_image = PhotoImage(file=roundedRectangleImage3)
myimage = Label(image=Search_image, bg="#57adff")
myimage.place(x=270, y=120)
Layer7 = "D:/2. College Work (Degree)/Second Year/3rd sem/Z. Mini Project – 1 A/weather forecast/Images/Layer 7.png"
weat_image = PhotoImage(file=Layer7)
...
textfield.focus()
Layer6 = "D:/2. College Work (Degree)/Second Year/3rd sem/Z. Mini Project – 1 A/weather forecast/Images/Layer 6.png"
Search_icon = PhotoImage(file=Layer6)
myimage_icon = Button(
...
# bottom Boxes
roundedRectangleImage2 = "D:/2. College Work (Degree)/Second Year/3rd sem/Z. Mini Project – 1 A/weather forecast/Images/Rounded Rectangle 2.png"
roundedRectangleImageCopy2 = "D:/2. College Work (Degree)/Second Year/3rd sem/Z. Mini Project – 1 A/weather forecast/Images/Rounded Rectangle 2 copy.png"
firstbox = PhotoImage(file=roundedRectangleImage2)
secondbox = PhotoImage(file=roundedRectangleImageCopy2)
...
# thpwd
t = Label(root, font=("Helvecita", 11), fg="white", bg="#203243")
t.place(x=150, y=120)
h = Label(root, font=("Helvecita", 11), fg="white", bg="#203243")
h.place(x=150, y=140)
p = Label(root, font=("Helvecita", 11), fg="white", bg="#203243")
p.place(x=150, y=160)
w = Label(root, font=("Helvecita", 11), fg="white", bg="#203243")
w.place(x=150, y=180)
d = Label(root, font=("Helvecita", 11), fg="white", bg="#203243")
d.place(x=150, y=200)
##first cell
